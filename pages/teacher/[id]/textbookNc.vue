          ...
          <div class="textbook_container">
            <div>
              ...
              <div class="resource-container">
                ...
                <div>
                  <div v-for="(pdf, index) in ['pdf_1', 'pdf_2', 'pdf_3', 'pdf_4', 'pdf_5','pdf_1_backup']">
                    <div v-if="item[pdf]">
                      <a
                          v-if="pdf === 'pdf_1_backup'"
                          :href="item[pdf]"
                          target="_blank"
                          class="dhbtn"
                      >
                        <img src="../../../assets/images/3_25.png" />教材{{ index + 1 }}(备用)
                      </a>
                      <a
                          v-else
                          :href="item[pdf]"
...
const getTextbookList = async() => {
  const { data: info} = await useOldTextbookListDataApi(courseParam.value,levelParam.value,sid.value);
  if (info?.value) {
