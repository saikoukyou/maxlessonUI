...
<!--            <li>{{lesson.integral_rank}}ポイント</li>-->
        ...
        <div class="lessonDecision_notes">
          <ul>
            <li>講師がお客様の<span style="font-weight: bold; color: #EF6D20"> {{lesson.software}}（ID： {{lesson.software == 'web' ? '' : (lesson.software == 'wechat' ? lesson.teacher_wechat : lesson.teacher_teams_id) }} ）</span>に連絡先を追加します。ご承認ください。</li>
