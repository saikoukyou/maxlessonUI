      ...
      <div class="roadmap_container textbook_container" v-for="(textbook,tindex) in textbookList">
        ...
        <div v-if="categoryInfo.learn_type == 0 && useStore?.learn_type == 1">
            <span v-if="textbook.status == 1 && textbook.show == 1">
              ...
              <!--              </div>-->
              <!--              <button v-if="textbook.zip_teacher" @click="shareLink(textbook.title,textbook.zip_teacher,'teacher')">分享教材给老师</button>-->
              <!--              <button v-if="textbook.pdf_2" @click="shareLink(textbook.pdf_1,textbook.pdf_2,'teacher')">分享pdf教材给老师</button>-->
            </span>
        ...
        <div v-else>
          <div v-if="textbook.class_status == 2">
            ...
            <!--              <div class="buttonArrowGreen">-->
            <!--                <a v-if="textbook.zip_student"  href="#" @click="openLink(textbook.zip_student)"><img src="~/assets/SVG/buttonArrowGreen.svg" alt=""></a>-->
            <!--                <a v-else href="#"><img src="~/assets/SVG/buttonArrowGreen.svg" alt=""></a>-->
            <!--              </div>-->
...
const openLink = (url) => {
  // console.log('openLinkurl:'+openLink);
...
.openBtn{
  background-color: #EF6D20; color: #FFFFFF; font-size: 12px; padding: 6px 8px; font-weight: bold;
  position: absolute;
  top: 32px;
  right: 100px;
}
